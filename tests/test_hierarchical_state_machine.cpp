...
TEST_F(HierarchicalStateMachineTest,
       StartsAutonomousFromStandbyWhenEnteringAutonomous) {
  hfsm::state_machine<Vehicle> sm;
  sm.start();
  ...
  auto& autonomous =
      sm.template get_state<Autonomous>();

  EXPECT_EQ(
      autonomous.current_state(),
      AutonomousState::Standby);
}
...
TEST_F(HierarchicalStateMachineTest,
       AutonomousTransitionsFromStandbyToCruising) {
  hfsm::state_machine<Vehicle> sm;
  sm.start();
...
TEST_F(HierarchicalStateMachineTest,
       AutonomousTransitionsFromCruisingToFollowing) {
  hfsm::state_machine<Vehicle> sm;
  sm.start();
...
TEST_F(HierarchicalStateMachineTest,
       AutonomousTransitionsFromFollowingBackToCruising) {
  hfsm::state_machine<Vehicle> sm;
  sm.start();
...
TEST_F(HierarchicalStateMachineTest,
       AutonomousTransitionsFromCruisingToParking) {
  hfsm::state_machine<Vehicle> sm;
  sm.start();
...
TEST_F(HierarchicalStateMachineTest,
       AutonomousTransitionsFromFollowingToParking) {
  hfsm::state_machine<Vehicle> sm;
  sm.start();
...
TEST_F(HierarchicalStateMachineTest,
       AutonomousReturnsToStandbyAfterParking) {
  hfsm::state_machine<Vehicle> sm;
  sm.start();
...
TEST_F(HierarchicalStateMachineTest,
       ExitsAutonomousAndReturnsToManual) {
  hfsm::state_machine<Vehicle> sm;
  sm.start();
...
TEST_F(HierarchicalStateMachineTest,
       ExitsAutonomousWhileChildIsCruising) {
  hfsm::state_machine<Vehicle> sm;
  sm.start();
...
TEST_F(HierarchicalStateMachineTest,
       ParentTransitionToEmergencyOverridesNestedState) {
  hfsm::state_machine<Vehicle> sm;
  sm.start();
...
TEST_F(HierarchicalStateMachineTest,
       TransitionsFromManualToEmergency) {
  hfsm::state_machine<Vehicle> sm;
  sm.start();
...
TEST_F(HierarchicalStateMachineTest,
       ExecutesCompleteHierarchicalStateSequence) {
  hfsm::state_machine<Vehicle> sm;
  sm.start();
