...
struct Playing : hfsm::state<Playing> {
  void on_entry() {
    ++context.playing_entry_count;
  }

  void on_update() {
    ++context.playing_update_count;
  }

  void on_exit() {
    ++context.playing_exit_count;
  }
};
...
TEST_F(SingleLevelStateMachineTest,
       DoesNotTransitionWhenGuardIsFalse) {
  hfsm::state_machine<MediaPlayer> sm;
...
TEST_F(SingleLevelStateMachineTest,
       TransitionsFromStoppedToPlaying) {
  hfsm::state_machine<MediaPlayer> sm;
...
TEST_F(SingleLevelStateMachineTest,
       TransitionsFromPlayingToPaused) {
  hfsm::state_machine<MediaPlayer> sm;
...
TEST_F(SingleLevelStateMachineTest,
       TransitionsFromPausedToPlaying) {
  hfsm::state_machine<MediaPlayer> sm;
...
TEST_F(SingleLevelStateMachineTest,
       TransitionsFromPlayingToStopped) {
  hfsm::state_machine<MediaPlayer> sm;
...
TEST_F(SingleLevelStateMachineTest,
       TransitionsFromPausedToStopped) {
  hfsm::state_machine<MediaPlayer> sm;
...
TEST_F(SingleLevelStateMachineTest,
       TransitionsFromPlayingToBuffering) {
  hfsm::state_machine<MediaPlayer> sm;
...
TEST_F(SingleLevelStateMachineTest,
       TransitionsFromBufferingToPlaying) {
  hfsm::state_machine<MediaPlayer> sm;
...
TEST_F(SingleLevelStateMachineTest,
       TransitionsFromBufferingToError) {
  hfsm::state_machine<MediaPlayer> sm;
...
TEST_F(SingleLevelStateMachineTest,
       IgnoresTransitionsFromOtherStates) {
  hfsm::state_machine<MediaPlayer> sm;
...
TEST_F(SingleLevelStateMachineTest,
       SelectsAvailableTransitionAmongMultipleOutgoingTransitions) {
  hfsm::state_machine<MediaPlayer> sm;
...
TEST_F(SingleLevelStateMachineTest,
       SelectsFirstAvailableTransitionWhenMultipleGuardsAreTrue) {
  hfsm::state_machine<MediaPlayer> sm;
...
TEST_F(SingleLevelStateMachineTest,
       SupportsMultipleSequentialTransitions) {
  hfsm::state_machine<MediaPlayer> sm;
