...
struct RunningMachine : hfsm::state_machine_def<RunningMachine, RunningState> {
    ...
    void enter_decision() {
        context.events.push_back("RunningMachine::enter_decision");
    }

    void start_fast() {
        context.events.push_back("RunningMachine::start_fast");
    }

    void start_slow() {
        context.events.push_back("RunningMachine::start_slow");
    }
